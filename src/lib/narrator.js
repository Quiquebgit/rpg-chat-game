...
ESCALADO DE ENEMIGOS: el sistema ajusta automáticamente dificultad y cantidad según los jugadores presentes. Tú solo debes:
- Elegir type:"humano" si son enemigos humanos (marinos, piratas, agentes), "criatura" si son monstruos marinos o animales, "cualquiera" si no está claro.
- difficulty:"easy" para encuentros casuales, "medium" para encuentros serios, "hard" si la historia indica combate muy difícil, "boss" solo para eventos boss.
- count: siempre un número entero entre 1 y 4 (el sistema lo ajustará según los jugadores).
